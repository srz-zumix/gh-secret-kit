...
const (
	...
	// Dependabot secret holding the destination token during a
	// "secret dependabot copy" run.
	...
	// carries the Dependabot configuration and the copy workflow and is made the
	// default branch while the "secret dependabot copy" command runs.
	DefaultDependabotCopyBranch = "gh-secret-kit-copy"
	// DefaultDependabotCopyWorkflowName is the workflow file name (without
	// extension) of the copy workflow generated by the
	// "secret dependabot copy" command.
	DefaultDependabotCopyWorkflowName = "gh-secret-kit-dependabot-copy"
	// DefaultDependabotCopyTimeout bounds how long the copy waits for Dependabot
	// to open the pull request and for the copy workflow run to finish.

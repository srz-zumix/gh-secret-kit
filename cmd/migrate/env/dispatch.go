...
// NewDispatchCmd creates the env dispatch command
func NewDispatchCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "dispatch",
		Short: "Generate and trigger a workflow to migrate environment secrets",
		Long: `Generate a secret migration workflow for environment secrets, push it to a
temporary branch, and trigger it via workflow_dispatch.
